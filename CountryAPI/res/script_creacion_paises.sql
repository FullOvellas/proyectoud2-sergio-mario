DELETE DATABASE BBDD_PAISES IF EXISTS;
CREATE DATABASE IF NOT EXISTS BBDD_PAISES;

USE BBDD_PAISES;

DELETE TABLE IF EXISTS MONEDAS;
...
DELETE TABLE IF EXISTS MONEDAS_PAISES;
...
DELETE TABLE IF EXISTS IDIOMAS;
...
DELETE TABLE IF EXISTS IDIOMAS_PAISES;
