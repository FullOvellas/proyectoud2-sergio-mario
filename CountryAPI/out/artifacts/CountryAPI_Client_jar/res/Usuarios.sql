...
CREATE TABLE IF NOT EXISTS TOKENS_USERS(
    ...
    USER_IP VARCHAR(14) NOT NULL,
	TOKEN CHAR(32) NOT NULL,
    
    FOREIGN KEY FK_USUARIO_TOKEN(ID_USER) REFERENCES USERS(ID_USER)
		ON DELETE CASCADE
        ON UPDATE CASCADE,
...
SELECT * FROM TOKENS_USERS;


SELECT ID_PAIS,P.NOMBRE,NUM_HABITANTES,CAPITAL 
	FROM PAISES AS P INNER JOIN IDIOMAS_PAISES AS IP 
		ON P.ID_PAIS = IP.PAIS INNER JOIN IDIOMAS AS I
			ON IP.IDIOMA = I.ID_IDIOMA AND I.NOMBRE LIKE "Spanish";
